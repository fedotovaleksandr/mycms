...
<?php if($data->count > 0) : ?>
    <table class="table table-hover">
        <thead>
            <tr>
                <th width="30">#</th>
                <th width="120"><?= Yii::t('easyii', 'Name') ?></th>
                <th width="80"><?= Yii::t('easyii/shopcart', 'Address') ?></th>
                <th width="80"><?= Yii::t('easyii/shopcart', 'Cost') ?></th>
                <th width="110"><?= Yii::t('easyii', 'Date') ?></th>
                <th width="120"><?= Yii::t('easyii', 'Назначен') ?></th>
