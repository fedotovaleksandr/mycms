 ...
 * @since 2.0
 */
class TachographModels extends ActiveRecord
{
    /**
    ...
    {
        parent::init();
        $this->_privateAdminName = 'Модель тахографа';
        $this->_privatePluralName = 'Модели тахографов';
    ...
    public static function getModels()
    {
      ...
      if($list === FALSE)
      {
        ...
        $list = $helper->getTachographModels();
      }
      return $list;
    }
    ...
    public static function getSoftVersionList()
    {
      $data = [];
      $helper = new \app\modules\lk\components\ProducerHelper();
      $modelList = $helper->getTachographModels();
    ...
    /**
     * список всех моделей тахографов
     * @staticvar type $data
     * @return type
     */
