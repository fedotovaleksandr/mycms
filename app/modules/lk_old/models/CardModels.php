 ...
 * @since 2.0
 */
class CardModels extends ActiveRecord
{
    /**
    ...
    {
        parent::init();
        $this->_privateAdminName = 'Модель карт тахографов';
        $this->_privatePluralName = 'Модели карт тахографов';
    ...
    {
      $helper = new \app\modules\lk\components\ProducerHelper();
      $modelList = $helper->getCardModels();
