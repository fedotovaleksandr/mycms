    ...
    <div class="breadcrumbs">
      <div class="container">
        <ul>
          ...
          <li class="active">Архив активизаций</li>
        </ul>
      </div>
    </div>
    <div class="container">
      <section>
        <div class="relative">
          <h1>Архив активизаций</h1>

          <form class="catalog-tah form-block">
            <div class="catalog-tah__inner">
              <div class="catalog-tah__item t20">
            <?=Html::dropDownList('archiveStatus', $request->get('archiveStatus'), $filters['archiveStatus']['values'], ['style' => 'width: 205px;', 'class' => 'edited']);?>
          </div>
		  <div class="catalog-tah__item t40">
            <fieldset>
              ...
              <div class="catalog-tah__item t30">
                <fieldset>
                  <input type="text" name="serialNumberFull" autocomplete="off" class="form-control <?=$request->get('serialNumberFull') ? 'edited' : ''?>" value="<?=$request->get('data')?>">
                  <label>Данные</label>
                </fieldset>
              </div>
          ...
          <tr>
            <th class="t5 text--center relative">
              ...
              <div aria-labelledby="dLabel" class="dropdown-menu">
                ...
                <?=Html::hiddenInput('table', 'archive');?>
