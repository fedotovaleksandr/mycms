<?php
$this->title = 'Добавить новую партию СКЗИ';
?>
<?=$this->render('menu');?>
  ...
  <div class="breadcrumbs">
    <div class="container">
      <ul>
        ...
        <li class="active">Добавить новую партию СКЗИ</li>
      </ul>
    </div>
  </div>
  <div class="container">
    <section>
      ...
      <div class="dropbox">
        <div class="dropbox__item t30">
          <h1>Добавить новую партию<br>СКЗИ</h1>
        </div>
        <div class="dropbox__item">
          <div class="dropbox__inner">
            ...
            <p class="input__text-js">
              <span class="text--primary text__md">Выбрать файл</span>
              <br><span class="text--default text__sm">или перетащите сюда файл, чтобы прикрепить его</span></p>
          </div>
        </div>
